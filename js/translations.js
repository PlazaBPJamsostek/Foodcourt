...
const translations = {
  id: {
    ...
    tenantDetail: {
      back: "Kembali ke Foodcourt",
      categoryFallback: "Tenant Foodcourt",
      photoPlaceholder: "Foto tenant segera tersedia",
      logoPlaceholder: "Logo Tenant",
      aboutTitle: "Tentang Tenant",
      menuTitle: "Menu",
      menuComingSoon: "Menu sedang diperbarui.",
      menuNote: "Menu dan harga dapat berubah sewaktu-waktu. Untuk info lengkap dan harga terkini, hubungi tenant melalui WhatsApp.",
      orderTitle: "Order / Kontak",
      orderCta: "Pesan via WhatsApp",
      orderMessage: "Halo {name}, saya ingin memesan...",
      orderUnavailable: "Nomor WhatsApp tenant ini belum tersedia.",
      orderUnavailableHint: "Sementara itu, hubungi Foodcourt Management untuk info tenant ini.",
      instagramLabel: "Instagram",
      promoTitle: "Promo & Berita",
      promoEmpty: "Belum ada promo terbaru.",
      managementTitle: "Foodcourt Management",
      managementDesc: "Untuk komplain fasilitas, pelayanan area, atau informasi umum Foodcourt.",
      managementCta: "Hubungi Foodcourt Management",
      managementMessage: "Halo Foodcourt Management, saya ingin menyampaikan...",
      relatedTitle: "Tenant Lainnya",
      viewDetail: "Lihat Detail",
      notFoundTitle: "Tenant Tidak Ditemukan",
      notFoundDesc: "Tenant yang kamu cari tidak tersedia atau sudah dipindahkan.",
      notFoundCta: "Kembali ke Foodcourt"
    }
  },
  ...
  en: {
    ...
    tenantDetail: {
      back: "Back to Foodcourt",
      categoryFallback: "Foodcourt Tenant",
      photoPlaceholder: "Tenant photo coming soon",
      logoPlaceholder: "Tenant Logo",
      aboutTitle: "About This Tenant",
      menuTitle: "Menu",
      menuComingSoon: "Menu is being updated.",
      menuNote: "Menu and prices may change at any time. For full details and current pricing, please contact the tenant via WhatsApp.",
      orderTitle: "Order / Contact",
      orderCta: "Order via WhatsApp",
      orderMessage: "Hi {name}, I'd like to order...",
      orderUnavailable: "This tenant's WhatsApp number isn't available yet.",
      orderUnavailableHint: "In the meantime, contact Foodcourt Management for info about this tenant.",
      instagramLabel: "Instagram",
      promoTitle: "Promotions & News",
      promoEmpty: "No recent promotions yet.",
      managementTitle: "Foodcourt Management",
      managementDesc: "For facility complaints, service issues, or general Foodcourt information.",
      managementCta: "Contact Foodcourt Management",
      managementMessage: "Hi Foodcourt Management, I'd like to share...",
      relatedTitle: "Other Tenants",
      viewDetail: "View Details",
      notFoundTitle: "Tenant Not Found",
      notFoundDesc: "The tenant you're looking for isn't available or may have moved.",
      notFoundCta: "Back to Foodcourt"
    }
  }
};
